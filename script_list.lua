...
script_manager = {
    ...
    _cache = {
        ...
        Dbo = {
            ...
            ['Reflect'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Dbo/reflect.lua',
        ...
        Nto = {
            ['Bug Map Kunai'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Nto/bug_map_kunai.lua',
                description = 'Script de bug map kunai para pc.',
                author = 'Ryan',
                enabled = false
            },
            ['Bug Map Kunai Mobile'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Nto/bug_map_mobile_kunai.lua',
                description = 'Script de bug map kunai para mobile.',
                author = 'VictorNeox',
                enabled = false
            },
            ['Stack'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Nto/stack.lua',
        ...
        Tibia = {
            ...
            ['Auto Mount'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/auto_mount.lua',
                description = 'Script de montagem automatica.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Cast Food'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/cast_food.lua',
                description = 'Script de castar/usar a food.',
                author = 'VivoDibra',
                enabled = false
            },
            ['E Ring'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/e_ring.lua',
                description = 'Script de e-ring.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Exeta Res'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/exeta_res.lua',
                description = 'Script de exeta res.',
                author = 'VivoDibra',
                enabled = false
            },
            ['MW Timer'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/mwall_timer.lua',
                description = 'Script de timer de MW.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Safe UE/SD'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/safe_ue_sd.lua',
                description = 'Script de safe UE/SD.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Share Exp'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/share_exp.lua',
                description = 'Script de safe UE/SD.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Utana Vid'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/utana_vid.lua',
                description = 'Script de utana vid.',
                author = 'VivoDibra',
                enabled = false
            },
            ['Utura'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Tibia/utura.lua',
        ...
        PvP = {
            ...
            ['Change Weapon'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/change_weapons.lua',
                description = 'Script trocar a arma baseado na distancia do target.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Follow Attack'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/follow_attack.lua',
                description = 'Script de follow attack, seguir o target.',
                author = 'VictorNeox',
                enabled = false
            },
            ['Enemy'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/enemy.lua',
                description = 'Script enemy, atacar o inimigo com menos hp na tela.',
                author = 'Ryan',
                enabled = false
            },
            ['Pvp Mode Icon'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/pvp_mode_icon.lua',
                description = 'Script alterar o modo da maozinha(pvp).',
                author = 'mrlthebest',
                enabled = false
            },
            ['Chase Mode Icon'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/chase_icon.lua',
                description = 'Script alterar o modo do chase.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Sense Target'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/sense_target.lua',
                description = 'Script de dar sense no target.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Anti Push'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/anti_push.lua',
                description = 'Script de anti push.',
                author = 'AnenScripts',
                enabled = false
            },
            ['MW Frente Target'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/PvP/mwall_target.lua',
        ...
        Healing = {
            ['Heal Friend'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Healing/heal_friend.lua',
                description = 'Script curar os amigos/party.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Potion'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Healing/potion.lua',
                description = 'Script de potion HP/MP.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Regeneration'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Healing/regeneration.lua',
        ...
        Utilities = {
            ...
            ['Buff'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/buff.lua',
                description = 'Script de buff pela mensagem laranja.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Bug Map Mobile'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/bug_map_mobile.lua',
                description = 'Script de bug map mobile.',
                author = 'VictorNeox',
                enabled = false
            },
            ['Cave/Target Bot Icon'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/cavebot_targetbot_icon.lua',
                description = 'Script de icone de targetbot e cavebot.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Change Gold'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/change_gold.lua',
            ...
            ['Creature HealthPercent'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/creature_hppercent.lua',
            ...
            ['Follow Player'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/follow_player.lua',
            ...
            ['Hide Texts'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/hide_texts.lua',
            ...
            ['Last Exiva'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/last_exiva.lua',
            ...
            ['MW Cursor'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/mw_cursor.lua',
                description = 'Script de soltar MW onde o cursor do mouse esta.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Shield Defense'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/mystic_defense.lua',
            ...
            ['Trade Message'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/send_message_trade.lua',
                description = 'Script de mandar msg no trade.',
                author = 'vBot',
                enabled = false
            },
            ['Speed'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/speed.lua',
            ...
            ['Storage Cave/Target Bot'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/storage_cavebot.lua',
                description = 'Script que ira separar o cavebot/targetbot atual de cada personagem.',
                author = 'mrlthebest',
                enabled = false
            },
            ['Time Spell'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/time_spell.lua',
            ...
            ['Turn Target'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/turn.lua',
            ...
            ['Stamina'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/stamina.lua',
                description = 'Script de usar stamina.',
                author = 'Asking',
                enabled = false
            },
            ['Script Manager'] = {
                url = 'https://raw.githubusercontent.com/LeydsonW/Scripts-Community/main/Scripts/Utilities/script_manager.lua',
